...
exports.when = exports.once = exports.removeAllListeners = exports.clear = exports.removeListener = exports.off = exports.addListener = exports.on = exports.fire = exports.Event = void 0;
...
const fire = (event, data) => event.forEach(callback => callback(data));
/**
